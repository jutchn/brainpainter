...
OUTPUT_FOLDER = 'E:/Users/spectR/Desktop/%Rutgers/RESEARCH/brain-coloring/output/Custom_output'
...
with open('IMG_TYPE.txt') as f:
  a = int(f.read())
with open('IMG_TYPE.txt', 'w') as output:
  if a != 2:
...
#COLORS_RGB_NEG = [(1,1,1), (0,1,1), (0,0.5,1), (0,0,1)] # white -> cyan -> azure -> blue

COLORS_RGB = [(1,1,0), (1,0.4,0), (1,0,0), (1,1,1)] #  yellow -> orange -> red -> white
COLORS_RGB_NEG = [(0,1,1), (0,0.5,1), (0,0,1), (1,1,1)] #  cyan -> azure -> blue -> white
# COLORS_RGB = [(1,1,1), (1,1,0), (1,0.75,0), (1,0.5,0), (1,0,0), (0,0,1)] # white -> yellow -> yellow-orange -> orange -> red -> blue
